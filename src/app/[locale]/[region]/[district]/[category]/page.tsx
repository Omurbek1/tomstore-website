...
import { ProductCard } from "./CategoryStyles";
...
function buildSeoText(locale: string, district: ReturnType<typeof getDistrict>, region: ReturnType<typeof getRegion>, cat: ReturnType<typeof getGeoCategory>): string[] {
  ...
  return [
    ...
    `Все товары идут с официальной гарантией производителя. Если вы живёте ${inCity} и ищете качественный ${cAcc} по справедливой цене — TomStore правильный выбор. Рассрочка от 3 до 12 мес. с банком и без банка. Подробнее: +996-508-724-365.`,
...
function buildFaqItems(locale: string, district: ReturnType<typeof getDistrict>, region: ReturnType<typeof getRegion>, cat: ReturnType<typeof getGeoCategory>) {
  ...
  return [
    ...
    },
    {
      ...
      a: `Да! Рассрочка от 3 до 12 месяцев — с банком и без банка — доступна по всему Кыргызстану, в том числе ${inCity}. Подробности: +996-508-724-365.`,
    },
    {
